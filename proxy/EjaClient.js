...
const logger = serverLogger.createLogger('EjaClient.js');
...
const postProxy = (req,res,next)=>{
    ...
    const userBase = new Buffer(body.user + ':' + body.password).toString('base64');
    axios({
        method: 'post',
        baseURL: SystemConfig.ejabberd.admin,
        headers: {'authorization': 'Basic ' + userBase},
